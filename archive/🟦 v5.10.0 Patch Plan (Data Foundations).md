## 🟦 v5.10.0 Patch Plan (Data Foundations)
...
No behavior changes yet — just analytics helpers + tests.
...
## ✅ Commit 1 — Add execution.intel package & expectancy_map
...
## ✅ Commit 2 — Add symbol scoring model
