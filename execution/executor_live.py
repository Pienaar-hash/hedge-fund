...
from execution.fill_tracker import (
    OrderAckInfo,
    FillSummary,
    fetch_order_status as _fetch_order_status,  # noqa: F401 - re-exported for tests
    fetch_order_trades as _fetch_order_trades,  # noqa: F401 - re-exported for tests
...
def _loop_once(state: ExecutorState, i: int) -> None:
    ...
    if INTENT_TEST:
        ...
        for idx, raw_intent in enumerate(intents_raw):
            ...
            # All other intents go through the candidate selector boundary.
            if not intent.get("reduceOnly"):
                try:
                    ...
                    if _ecs_result["selected"] is not None:
                        ...
                        # Preserve merge scores for calibration telemetry
                    ...
                    try:
                        log_ecs_soak_event(
                            ...
                            merge_hydra_score=raw_intent.get("merge_hydra_score"),
                            merge_legacy_score=raw_intent.get("merge_legacy_score"),
