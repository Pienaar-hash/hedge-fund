...
- Dashboard supervisor entry now runs `streamlit` through `/root/hedge-fund/venv/bin/python3 -m streamlit run dashboard/app.py`, exposing the UI on `0.0.0.0:8501`.
